...
<script>
function fn_reply() {
	location = "/myproject1/replyWrite.do?unq=${resultDetail.unq}&thread=${resultDetail.thread}";
}

function fn_modify() {
	location = "/myproject1/reboardModify.do?unq=${resultDetail.unq}";
}

function fn_delete() {
	location = "/myproject1/reboardPassWrite.do?unq=${resultDetail.unq}";
}	
